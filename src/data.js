export const navLinks = ['Home', 'Cake', 'Pastries', 'About']
...
export const eventPerks = [
  'Custom theme cakes for any party size',
  'Wide variety of flavours available',
  'Add extra cakes, pastries & desserts',
]

export const eventImages = [
  'https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?auto=format&fit=crop&w=500&q=80',
  'https://images.unsplash.com/photo-1557925923-cd4648e211a0?auto=format&fit=crop&w=500&q=80',
]
...
export const testimonials = [
  ...
  {
    text: '"We ordered a custom Red Velvet cake for my daughter\'s birthday. It looked absolutely stunning and tasted heavenly. Thank you for making her day special!"',
    name: 'Michael Roberts',
    role: 'Event Booking',
    image: 'https://i.pravatar.cc/100?img=12',
  },
  {
    text: '"Their pastries are to die for! So fresh and the perfect texture. The hygiene standards they stick to are clearly visible and that impresses me."',
    name: 'Emily Chen',
    role: 'Verified Buyer',
